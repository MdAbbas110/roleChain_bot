...
const [buttonDisabled, setButtonDisabled] = useState(false);
    ...
    const transaction = (cost) => ({
        ...
        messages: [
            {
                address: "UQCD8F2An8xoC0Y2F66UhuQ6h1lQJKoVbSq9DDoQ_mC1t_s3",
            ...
            setCongratsMessage(
                <div className="w-full flex justify-center flex-col items-center space-y-3">
                    ...
                    <span className="font-medium text-[20px] text-[#ffffff] pt-2 pb-2 flex items-center space-x-1">
                        <img src='/tracex.webp' alt='refd' className='w-[22px]'/>
                        <span className={`text-accent`}>{selectedCard.profit}</span> <span>$CRIB CLAIMED</span>
                    </span>
                    <p className="pb-6 text-[15px] w-full text-center">
                        Your claimed $CRIB will be kept safe in your wallet till token launch. You can also swap your $CRIB to other listed assets in the wallets menu.
                    </p>
                </div>
            );
    ...
    //                     </span>
    //                     <p className="pb-6 text-[15px] w-full text-center">
    //                       Your claimed TON will be kept safe in your wallet till token launch. You can also swap your TON for more MAX tokens or other listed assets in the wallets menu.
    //                     </p>
    //                   </div>
    //                 );
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center space-x-1 pt-1">
                ...
                <img src='/tracex.webp' alt='coin' className='w-[12px]' />
                <span className='text-[12px] font-semibold'>
                    {formatNumber(card.profit)} $CRIB
                </span>
            </div>
                            ...
                            <div className="w-full flex taskbg rounded-tl-[40px] rounded-tr-[40px] mt-[2px] justify-center relative flex-col items-center space-y-3 p-4 pt-20 pb-10">
                                ...
                                <div className="w-full flex justify-center flex-col items-center">
                                    ...
                                    <div className="pb-6 text-primary flex items-center justify-center w-full space-x-1 font-semibold text-[15px] px-4 text-center">
                                       <span> Profit:</span> <span className='pl-1'><img src='tracex.webp' alt='dfd' className='w-[14px] h-[14px]'/></span> <span className='text-green-500 '>+{(selectedCard.profit)} $CRIB</span> 
                                    </div>
                                </div>
