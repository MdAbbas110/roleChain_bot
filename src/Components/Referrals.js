...
const Referrals = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/tracextapbot?start=r${id}\n\$CRIB tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! $CRIB Power Tap! 🚀`;
  ...
  const handleShare = async () => {
    const shareData = {
      title: "Mine $CRIB tokens now!",
      // eslint-disable-next-line
      url: `https://t.me/tracextapbot?start=r${id}\n\ `, // Replace with your link
      text: "$CRIB tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! Tracex Power Tap! 🚀",
    };
  ...
  const fallbackShare = (shareData) => {
    const encodedText = encodeURIComponent(
      // eslint-disable-next-line
      `${shareData.url} \n\$CRIB tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! Tracex Power Tap! 🚀`
    );
...
">Close</button>
  ...
  return (
    <>
      ...
      <>
        <Animate>
          <div className="w-full justify-center flex-col space-y-3">
            ...
            <div className="w-full flex items-center justify-between space-x-3 pb-3">
              ...
              <div className="w-[48.5%] flex flex-col text-[#000] font-medium text-[14px] bg-cards h-[85px] rounded-[10px] px-4 py-2 justify-start text-left relative">
                <h2 className="!m-0 font-semibold text-[#fff]">
                  ...
                  <span className="text-[18px]"> $CRIB</span>
                </h2>
