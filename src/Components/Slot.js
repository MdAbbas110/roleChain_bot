...
const SlotMachine = () => {
  ...
  const height = 210;
  const reels = [
    ["/bnb2.webp", "/tracex.webp", "/bitcoin.png"],
    ["/bnb2.webp", "/tracex.webp", "/bitcoin.png"],
    ["/bnb2.webp", "/tracex.webp", "/bitcoin.png"],
  ];
      ...
      <div className='w-full flex justify-between items-center pb-2 px-4'>
        ...
        <div className='flex items-center'>
          <span className='flex items-center mt-[-1px]'>
            <img src='/loadernew.webp' className='w-[20px] bounce-animation-2s' alt='engagecoin'/>
          </span>
          <span className='text-[#fff] font-semibold text-[16px]'>
            <span className='pl-[4px]'>{formatNumber(points)} <span className='text-secondary'>$CRIB</span></span>
          </span>
        </div>
