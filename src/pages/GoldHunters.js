...
const userLevels = [
  { id: 1, name: 'Elite', icon: '/elite.webp', tapBalanceRequired: 1000 },
  { id: 2, name: 'Master', icon: '/masterr.webp', tapBalanceRequired: 50000 },
  { id: 3, name: 'Grandmaster', icon: '/grandmaster.webp', tapBalanceRequired: 500000 },
  { id: 4, name: 'Epic', icon: '/epic.webp', tapBalanceRequired: 1000000 },
  { id: 5, name: 'Legend', icon: '/legend.webp', tapBalanceRequired: 2500000 },
  { id: 6, name: 'Mythic', icon: '/mythic.webp', tapBalanceRequired: 5000000 },
];
...
<span className='text-[16px]'>
        ...
        <NavLink to='/boost' className='bg-cards3 py-[15px] px-5 text-[#dddddd] font-medium w-[45%] flex justify-center space-x-1 items-center rounded-[6px] text-[15px]'>
          <span className='text-[16px]'>
      ...
      <img src='/loadernew.webp'className='w-[50px] bounce-animation-2s' alt='engagecoin'/>
         <span className='text-[#fff] text-[32px] font-bold'>
           <span className='pl-[2px]'>{formatNumber(balance + refBonus)} <span className='text-btn4'>$CRIB</span></span>
        </span>
      </h1>
      <div>
  ...
  <div class="after"></div>
      ...
      {energy === 0 && points === 0 ? (
          ...
          <span className='text-[#fff] font-semibold text-[24px]'>
            <span className='pl-[2px]'>{points} <span className='text-btn4'>$CRIB</span></span>
          </span>
          <button 
            onClick={handleClaim} 
            disabled={points === 0} 
        ...
        <div className={`${
          ...
          <div className="w-full flex justify-center flex-col items-center space-y-3">
            ...
            <h3 className="font-medium text-[24px] text-[#ffffff] pt-2 pb-2">
              <span className='text-accent'>+{points}</span> $CRIB
            </h3>
            <p className="pb-6 text-[#bfbfbf] text-[15px] w-full text-center">
              Keep grinding! something huge is coming! Get more $CRIB now! 
            </p>
...
<div className={`w-full bg-divider shadowtop rounded-tl-[40px] rounded-tr-[40px] relative flex flex-col ease-in duration-300 transition-all justify-center`}>
  ...
  Discover Tracex Bot <br/> Earn $CRIB, Convert to USDT, & Claim Airdrops!
</h1>

<p className='text-[13px] px-6'>
  Unlock exclusive rewards, trade seamlessly, and boost your earnings with every tap. Join the journey to financial freedom today!
</p>
